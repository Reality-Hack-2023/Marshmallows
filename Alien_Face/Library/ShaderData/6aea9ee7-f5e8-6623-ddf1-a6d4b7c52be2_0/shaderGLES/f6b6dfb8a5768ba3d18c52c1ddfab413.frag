...
vec3 BlendColorDodge(vec3 base, vec3 blend)
{
    ...
    return vec3(BlendColorDodge(param, param_1), BlendColorDodge(param_2, param_3), BlendColorDodge(param_4, param_5));
}
...
vec3 ApplyBlendMode(vec3 base, vec3 blend, float opacity)
{
    ...
    ret = BlendColorDodge(param, param_1, param_2);
    return ret;
}
